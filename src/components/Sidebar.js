...
const Sidebar = () => {
  return (
    <div style={{top: '0.5rem'}} className='fixed'>
        <img className='rounded-full mt-1 mx-2 cursor-pointer' src='https://lh3.googleusercontent.com/ogw/AOLn63E-mxcUF8KVHQJCzkiOzl_UHABc6ndrurW_RSv8SfI=s32-c-mo' alt=''/>
